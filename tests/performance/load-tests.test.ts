 ...
 * Оригинальный файл сохранен как: tests/performance/load-tests.test.ts.backup
 * 
...
describe('Performance Tests for Monetization', () => {
    beforeAll(async () => {
        testLogger.info('TEST', '🚀 Запуск тестов производительности')
    })

    afterAll(async () => {
        testLogger.info('TEST', '✅ Тесты производительности завершены')
    })
