...
echo ""
echo "📚 Документация:"
echo "  - @background-agents - правила работы с агентами"
echo "  - @agent.json - конфигурация агентов"
echo "  - @environment.json - настройка окружения"
echo "  - @.cursor/rules/ - правила проекта"
echo ""
echo "🌐 Веб-интерфейс: https://cursor.com/agents"
echo "🎯 Режим агента: Ctrl+E в IDE"
